...
(function (factory) {
  ...
  var MobileNavigation = /*#__PURE__*/function () {
    ...
    _createClass(MobileNavigation, [{
      ...
      value: function _calculateMaxHeight() {
        if (this.isOpen) {
          this.mobileMenuElement.style.maxHeight = document.querySelector('.mobile-menu').scrollHeight + "px";
        }
      }
    }, {
      key: "_onWindowClick",
    ...
    _createClass(PopoverManager, [{
      ...
      value: function _openPopover(target) {
        ...
        if (Responsive.getCurrentBreakpoint() === 'phone') {
          ...
          if (panelList) {
            ...
            panelList.style.maxHeight = "".concat(panelList.clientHeight, "px");
          }
        }
      ...
      value: function _windowResized() {
        if (Responsive.getCurrentBreakpoint() === 'phone' && this.activePopover) {
          this.activePopover.style.maxHeight = "".concat(window.innerHeight - document.querySelector('.header').getBoundingClientRect().bottom, "px");
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateAddToCartButton(newVariant) {
        var addToCartButtonElement = this.element.querySelectorAll('.product-form__add-button'),
        ...
        for(var i=0; i< addToCartButtonElement.length; i++){

        if (!newVariant) {
          addToCartButtonElement[i].setAttribute('disabled', 'disabled');
          addToCartButtonElement[i].classList.add('btn-sold_out');
          addToCartButtonElement[i].removeAttribute('data-action');
          addToCartButtonElement[i].innerHTML = window.languages.productFormUnavailable;
          infoListElement.style.display = 'none';
        } else {


          if (newVariant['available']) {
            addToCartButtonElement[i].removeAttribute('disabled');
            addToCartButtonElement[i].classList.remove('btn-sold_out');
            addToCartButtonElement[i].setAttribute('data-action', 'add-to-cart');
            addToCartButtonElement[i].innerHTML = window.languages.productFormAddToCart;
          } else {
            addToCartButtonElement[i].setAttribute('disabled', 'disabled');
            addToCartButtonElement[i].classList.add('btn-sold_out');
            addToCartButtonElement[i].removeAttribute('data-action');
            addToCartButtonElement[i].innerHTML = window.languages.productFormSoldOut;
          }
  ...
  */
        ...
        fastdom.mutate(function () {
          ...
          _this2.element.querySelectorAll('.product-item').forEach(function (item) {
            if (newLayoutMode === 'grid') {
              item.className = "product-item card bike-product";
            } else {
              item.className = 'product-item card bike-product product-item--list';
            }
          }); // Reload the swatches
        ...
        if (userAgent.includes('safari') && (userAgent.includes('version/10.1') || userAgent.includes('version/10.3') || userAgent.includes('version/11.0'))) {
          ...
          this.element.querySelectorAll('.product-item__image-wrapper .aspect-ratio, .product-item__image-wrapper .placeholder-svg').forEach(function (image) {
            if (isPhone) {
              ...
              image.parentNode.style.maxHeight = "".concat(image.clientHeight, "px");
            }
          });
        }
      }
  ...
  var EbikeHeaderSection = /*#__PURE__*/function () {
    function EbikeHeaderSection(element) {
      _classCallCheck(this, EbikeHeaderSection);

      this.flickityInstance = new js(element.querySelector('.ebike-header'), {
        pageDots: true,
        prevNextButtons: true,
        adaptiveHeight: true,
        wrapAround: true,
    ...
    _createClass(EbikeHeaderSection, [{
      key: "onUnload",
      value: function onUnload() {
        this.flickityInstance.destroy();
      }
    ...
    return EbikeHeaderSection;
  }();


  var ArticleSection = /*#__PURE__*/function () {
    function ArticleSection(element) {
      _classCallCheck(this, ArticleSection);

      this.flickityInstance = new js(element.querySelector('.article-container'), {
        pageDots: true,
        prevNextButtons: false,
        wrapAround: true,
        autoPlay: 5000,
  ...
  var LogoListSection = /*#__PURE__*/function () {
    function LogoListSection(element) {
      ...
      this.flickityInstance = new js(element.querySelector('.logo-list'), {
        pageDots: true,
        prevNextButtons: false,
        wrapAround: true,
        autoPlay: 5000,
  ...
  (function () {
    var bootTheme = function bootTheme() {
      ...
      sections.register('ebike-header', EbikeHeaderSection);
      ...
      sections.register('article-container', ArticleSection);
